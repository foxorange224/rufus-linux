...
[![CMake Build Status](https://img.shields.io/github/actions/workflow/status/FoxOrange224/rufus-linux/cmake.yml?branch=main&style=flat-square&label=Build)](https://github.com/FoxOrange224/rufus-linux/actions)
...
* Format USB flash drives and virtual drives to FAT32, NTFS, exFAT, and ext2/3/4.
...
* Native GTK/Qt integration with a clean, lightweight, and familiar UI design.
